              ...
              <div className="max-w-7xl mx-auto">
                <div className="mb-10 md:max-w-md mx-auto text-center">
                  ...
                  <p className="text-gray-400 font-bold">
                    Led programming specializes in web development and website
                    creation services. We design and build custom, responsive,
                    and visually appealing websites tailored to meet the unique
                    needs of businesses and individuals, utilizing the latest
                    technologies and frameworks for optimal functionality and
                    performance.
                  </p>
                </div>
                <div className="flex flex-wrap -m-4">
                  <div className="w-full md:w-1/3 p-4">
                    <div className="p-10 text-center h-full bg-gray-900 rounded-3xl">
                      ...
                      <h3 className="font-heading mb-2 text-xl text-white font-black">
                        Offer Customized Solutions
                      </h3>
                      <p className="text-gray-500 font-bold">
                        Tailor websites to meet each client's unique needs,
                        ensuring a personalized web presence that aligns with
                  ...
                  <div className="w-full md:w-1/3 p-4">
                    <div className="p-10 text-center h-full bg-gray-900 rounded-3xl">
                      ...
                      <p className="text-gray-500 font-bold">
                        Develop websites optimized for all devices, providing a
                        seamless and user-friendly experience on smartphones,
                        tablets, and desktops through mobile-first design.
                      </p>
                    </div>
                  </div>
                  <div className="w-full md:w-1/3 p-4">
                    <div className="p-10 text-center h-full bg-gray-900 rounded-3xl">
                      ...
                      <p className="text-gray-500 font-bold">
                        Offer continuous support and maintenance services to
                        keep websites updated, secure, and running smoothly,
                        including regular updates and troubleshooting.
                      </p>
                    </div>
                  </div>
                </div>
