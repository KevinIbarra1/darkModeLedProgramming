  ...
  presets: [
    {
      theme: {
        ...
        backgroundImage: {
          ...
          "gradient-red-light":
            "linear-gradient(180deg, #F9D1AA 0%, #EF1460 100%)",
          "gradient-orange-light":
            "linear-gradient(180deg, #F9D1AA 0%, #EF1460 200%)",
          "gradient-orange":
            "linear-gradient(98.24deg, #FC8B13 0%, #FA35C1 100%)",
          "gradient-green":
            "linear-gradient(104deg, rgba(223,244,244,1) 0%, rgba(60,231,181,1) 40%)",
          "gradient-green-dark":
            "linear-gradient(98.24deg, #06E992 0%, #0289EB 100%)",
          "gradient-pink":
            "linear-gradient(98.24deg, #C9275A 0%, #DD15E8 100%)",
          "gradient-aqua":
            "linear-gradient(98.24deg, #55F7DC 0%, #5BC9F9 100%)",
        ...
        fontFamily: {
          ...
          heading:
            '"Satoshi", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"',
